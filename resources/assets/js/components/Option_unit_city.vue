        ...
        <div class="row">
            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-default">
                    <div class="panel-heading">Edit list: <strong>CITY Unit</strong></div>
                    <div class="panel-body">
    <!-- add new unit -->
                        <form>
                            <div class="form-group">
                                <label for="region">Select Region</label>
                                 <select @change="filteredRegionForCity" name="region" class="form-control" v-model="selected_add.current_region">
                            ...
                            <div class="form-group">
                                <label for="region">Select state</label>
                                 <select name="state" class="form-control" v-model="selected_add.current_state">
                                    <option selected disabled value="">Select state ...</option>
                                    <option v-for="(state, key) in states" :value="state.id">{{ state.name }}</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="state">Add new city</label>
                                <input type="text" name="city" class="form-control" v-model="selected_add.add_new" placeholder="Typing new city name ...">
                            </div>
...
export default {
  ...
  methods:{
      ...
      filteredRegionForCity(){
          axios.post('/filteredRegionForCity', {'region': this.selected_update.current_region}).then((response)=>{
              this.states = response.data 
          })
      },
